...
const dict = {
  ...
  noParentPhone: { en: "No parent phone on file — add one to send SMS.", uz: "Ota-ona telefoni yo'q — SMS uchun qo'shing." },
  parentOptedOut: { en: "Parent opted out of SMS", uz: "Ota-ona SMS dan voz kechgan" },

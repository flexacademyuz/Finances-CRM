...
const dict = {
  ...
  smsOptOut: { en: "Don't send SMS to this number", uz: "Bu raqamga SMS yubormaslik" },
  sms: { en: "SMS", uz: "SMS" },
  smsHistory: { en: "SMS history", uz: "SMS tarixi" },
  sendSms: { en: "Send SMS", uz: "SMS yuborish" },
  noSmsYet: { en: "No messages sent yet.", uz: "Hali xabar yuborilmagan." },
  noParentPhone: { en: "No phone number on file — add one to send SMS.", uz: "Telefon raqami yo'q — SMS uchun qo'shing." },
  parentOptedOut: { en: "SMS turned off for this number", uz: "Bu raqam uchun SMS o'chirilgan" },
  ...
  greeting: { en: "Hey", uz: "Salom" },
  dashboardSubtitle: { en: "Your center at a glance.", uz: "Markazingiz — bir qarashda." },
  recentPayments: { en: "Recent payments", uz: "So'nggi to'lovlar" },
  viewAll: { en: "View all", uz: "Barchasi" },
  quickActions: { en: "Quick Actions", uz: "Tezkor amallar" },
  quickActionsSub: { en: "Save time, get things done", uz: "Vaqtni tejang, ishni bajaring" },
  addStudentAction: { en: "Add Student", uz: "O'quvchi qo'shish" },
  createGroup: { en: "Create Group", uz: "Guruh yaratish" },
  generateReport: { en: "Generate Report", uz: "Hisobot olish" },
  recentActivity: { en: "Recent Activity", uz: "So'nggi harakatlar" },
  paymentReceived: { en: "Payment received", uz: "To'lov qabul qilindi" },
  vsLastMonth: { en: "vs last month", uz: "o'tgan oyga nisbatan" },
  noActivity: { en: "No recent activity", uz: "So'nggi harakatlar yo'q" },
  ago: { en: "ago", uz: "oldin" },
  studentsSubtitle: { en: "Manage and track all your students in one place.", uz: "Barcha o'quvchilarni bir joyda boshqaring." },
  activeStudents: { en: "Active Students", uz: "Faol o'quvchilar" },
  inactiveStudents: { en: "Inactive Students", uz: "Nofaol o'quvchilar" },
  ...
  totalCollected: { en: "Total collected", uz: "Jami yig'ilgan" },
  payrollSubtitle: { en: "Review and pay teacher salaries.", uz: "O'qituvchilar maoshini ko'ring va to'lang." },
  leadsSubtitle: { en: "New-student intake and approvals.", uz: "Yangi o'quvchilar va tasdiqlash." },
  expensesSubtitle: { en: "Track and manage center expenses.", uz: "Markaz xarajatlarini yuriting." },
  groupsSubtitle: { en: "Your classes, teachers and fees.", uz: "Guruhlar, o'qituvchilar va to'lovlar." },
  teacher_count: { en: "Teachers", uz: "O'qituvchilar" },
  toPay: { en: "To pay", uz: "To'lanadigan" },
  paidThisMonth: { en: "Paid", uz: "To'langan" },
  recordPaymentSubtitle: { en: "Log this month's tuition in a few taps.", uz: "Bu oylik to'lovni bir necha bosishda kiriting." },
  financesSubtitle: { en: "Revenue, expenses and net profit.", uz: "Daromad, xarajat va sof foyda." },
  analyticsSubtitle: { en: "Trends across your center.", uz: "Markazingiz bo'yicha tahlillar." },
  usersSubtitle: { en: "Team, roles and permissions.", uz: "Jamoa, rollar va ruxsatlar." },
  awaitingSubtitle: { en: "Students who owe for this month.", uz: "Bu oy uchun qarzi bor o'quvchilar." },
  myClassesSubtitle: { en: "Your groups and rosters.", uz: "Guruhlaringiz va ro'yxatlar." },
  mySalarySubtitle: { en: "Your monthly salary and history.", uz: "Oylik maoshingiz va tarixi." },
  financialDetail: { en: "Financial detail", uz: "Moliyaviy tafsilot" },
  paymentsTrend: { en: "Payments · 6M", uz: "To'lovlar · 6 oy" },
  revenueTrend: { en: "Revenue · last 6 months", uz: "Daromad · so'nggi 6 oy" },
  voided: { en: "Void", uz: "Bekor" },
